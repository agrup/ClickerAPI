...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('markers')->insert(['distancia'=>1000,'latitud'=>51.509865,'longitud'=>-0.118092,'oro'=>100,'millas'=>1000,'completa'=>'incompleta']);
        DB::table('markers')->insert(['distancia'=>1000,'latitud'=> -33.447487,'longitud'=>-70.673676,'millas'=>1000,'experiencia'=>'100','completa'=>'incompleta']);
        DB::table('markers')->insert(['distancia'=>1000,'latitud'=>-23.533773,'longitud'=>-46.625290,'ataque'=>0.5,'vida'=>5,'completa'=>'incompleta']);
        DB::table('markers')->insert(['distancia'=>1000,'latitud'=>-12.592502,'longitud'=>18.723946,'experiencia'=>50,'ataque'=>0.1,'vida'=>5,'completa'=>'incompleta']);
